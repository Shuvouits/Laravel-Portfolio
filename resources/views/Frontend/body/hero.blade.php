         ...
         <div class="row gy-5" data-aos="fade-in">
             <div
                 ...
                 <p style="font-size : 20px">
                     A passionate full-stack web application developer with expertise in a variety of technologies. With
                     a strong background in Laravel, WordPress, React.js, Node.js, PHP, and Vue.js, I bring a wealth of
                     experience to any project I work on.
                 </p>
             ...
             <div class="col-lg-6 order-1 order-lg-2">
                 <img src="{{ asset('Frontend/assets/img/shuvo.jpg') }}"
                     style="width: 500px; height : 500px; border-radius: 250px" class="img-fluid" alt=""
